<?php
	class libros
	{
		...
		function guardar($procedimiento,$caracter,$pini,$pfin,$rb,$fndescarga,$li,$seccion,$imagen)
		{
			$sql= "INSERT INTO licitaciones VALUES(null,'$procedimiento','$caracter','$pini','$pfin','$rb','$fndescarga', '$li', '$seccion','$imagen')";
			//$sql="UPDATE libros SET isbn_libro = '$isbn',titulo_libro='$titulo',autor_libro='$autor',publicacion_libro='$añop', paginas_libro='$nrop', ediccion_libro='$ediccion',idioma_libro='$idioma' WHERE id_libro='$idlib'";
			if($this->conexion->conexion->query($sql)){
				return true;
			}
